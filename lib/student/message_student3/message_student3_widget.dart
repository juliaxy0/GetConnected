...
import 'message_student3_model.dart';
export 'message_student3_model.dart';

class MessageStudent3Widget extends StatefulWidget {
  const MessageStudent3Widget({Key? key}) : super(key: key);

  @override
  _MessageStudent3WidgetState createState() => _MessageStudent3WidgetState();
}

class _MessageStudent3WidgetState extends State<MessageStudent3Widget> {
  late MessageStudent3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MessageStudent3Model());
  }
