...
import 'search_baru2_model.dart';
export 'search_baru2_model.dart';

class SearchBaru2Widget extends StatefulWidget {
  const SearchBaru2Widget({Key? key}) : super(key: key);

  @override
  _SearchBaru2WidgetState createState() => _SearchBaru2WidgetState();
}

class _SearchBaru2WidgetState extends State<SearchBaru2Widget> {
  late SearchBaru2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchBaru2Model());
  }
                                          ...
                                          children: [
                                            ClipRRect(
                                              borderRadius:
                                                  BorderRadius.circular(30.0),
                                              child: Image.network(
                                                'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d8/Baskin-Robbins_logo.svg/1024px-Baskin-Robbins_logo.svg.png',
                                                width: 60.0,
                                                height: 60.0,
                                                fit: BoxFit.cover,
                                              ),
                                          ...
                                          children: [
                                            ClipRRect(
                                              borderRadius:
                                                  BorderRadius.circular(30.0),
                                              child: Image.network(
                                                'https://www.thestarling.com.my/upload/tenant/gsc-logo.jpg',
                                                width: 60.0,
                                                height: 60.0,
                                                fit: BoxFit.cover,
                                              ),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              'Golden Screen Cinema Sdn Bhd - KL',
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
                                                  .override(
