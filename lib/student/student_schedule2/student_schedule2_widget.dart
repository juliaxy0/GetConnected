...
import 'student_schedule2_model.dart';
export 'student_schedule2_model.dart';

class StudentSchedule2Widget extends StatefulWidget {
  const StudentSchedule2Widget({Key? key}) : super(key: key);

  @override
  _StudentSchedule2WidgetState createState() => _StudentSchedule2WidgetState();
}

class _StudentSchedule2WidgetState extends State<StudentSchedule2Widget> {
  late StudentSchedule2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StudentSchedule2Model());
  }
