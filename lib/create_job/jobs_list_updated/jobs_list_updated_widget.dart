...
import 'jobs_list_updated_model.dart';
export 'jobs_list_updated_model.dart';

class JobsListUpdatedWidget extends StatefulWidget {
  const JobsListUpdatedWidget({Key? key}) : super(key: key);

  @override
  _JobsListUpdatedWidgetState createState() => _JobsListUpdatedWidgetState();
}

class _JobsListUpdatedWidgetState extends State<JobsListUpdatedWidget> {
  late JobsListUpdatedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JobsListUpdatedModel());
  }
