...
import 'joborpost_d_e_d_u_c_t_e_d_model.dart';
export 'joborpost_d_e_d_u_c_t_e_d_model.dart';

class JoborpostDEDUCTEDWidget extends StatefulWidget {
  const JoborpostDEDUCTEDWidget({Key? key}) : super(key: key);

  @override
  _JoborpostDEDUCTEDWidgetState createState() =>
      _JoborpostDEDUCTEDWidgetState();
}

class _JoborpostDEDUCTEDWidgetState extends State<JoborpostDEDUCTEDWidget> {
  late JoborpostDEDUCTEDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JoborpostDEDUCTEDModel());
  }
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      context.pushNamed('AttendanceReportCLOCKOUT');
                    },
                    child: Stack(
                      children: [
                        Align(
