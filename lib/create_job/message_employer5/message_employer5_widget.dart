...
import 'message_employer5_model.dart';
export 'message_employer5_model.dart';

class MessageEmployer5Widget extends StatefulWidget {
  const MessageEmployer5Widget({Key? key}) : super(key: key);

  @override
  _MessageEmployer5WidgetState createState() => _MessageEmployer5WidgetState();
}

class _MessageEmployer5WidgetState extends State<MessageEmployer5Widget> {
  late MessageEmployer5Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MessageEmployer5Model());
  }
                                ...
                                Expanded(
                                  child: Align(
                                    ...
                                    child: InkWell(
                                      ...
                                      highlightColor: Colors.transparent,
                                      onTap: () async {
                                        context.pushNamed('messageEmployer5');
                                      },
                                      child: Icon(
