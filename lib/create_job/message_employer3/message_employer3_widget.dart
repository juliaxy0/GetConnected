...
import 'message_employer3_model.dart';
export 'message_employer3_model.dart';

class MessageEmployer3Widget extends StatefulWidget {
  const MessageEmployer3Widget({Key? key}) : super(key: key);

  @override
  _MessageEmployer3WidgetState createState() => _MessageEmployer3WidgetState();
}

class _MessageEmployer3WidgetState extends State<MessageEmployer3Widget> {
  late MessageEmployer3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MessageEmployer3Model());
  }
                                ...
                                Expanded(
                                  child: Align(
                                    ...
                                    child: InkWell(
                                      ...
                                      highlightColor: Colors.transparent,
                                      onTap: () async {
                                        context.pushNamed('messageEmployer3');
                                      },
                                      child: Icon(
