...
import 'jobs_list_befor_update_model.dart';
export 'jobs_list_befor_update_model.dart';

class JobsListBeforUpdateWidget extends StatefulWidget {
  const JobsListBeforUpdateWidget({Key? key}) : super(key: key);

  @override
  _JobsListBeforUpdateWidgetState createState() =>
      _JobsListBeforUpdateWidgetState();
}

class _JobsListBeforUpdateWidgetState extends State<JobsListBeforUpdateWidget> {
  late JobsListBeforUpdateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JobsListBeforUpdateModel());
  }
