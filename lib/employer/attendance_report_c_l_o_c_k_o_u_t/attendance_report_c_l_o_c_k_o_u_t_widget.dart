...
import 'attendance_report_c_l_o_c_k_o_u_t_model.dart';
export 'attendance_report_c_l_o_c_k_o_u_t_model.dart';

class AttendanceReportCLOCKOUTWidget extends StatefulWidget {
  const AttendanceReportCLOCKOUTWidget({Key? key}) : super(key: key);

  @override
  _AttendanceReportCLOCKOUTWidgetState createState() =>
      _AttendanceReportCLOCKOUTWidgetState();
}

class _AttendanceReportCLOCKOUTWidgetState
    extends State<AttendanceReportCLOCKOUTWidget>
    with TickerProviderStateMixin {
  late AttendanceReportCLOCKOUTModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AttendanceReportCLOCKOUTModel());
  }
