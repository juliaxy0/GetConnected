...
import 'job_description_employer_model.dart';
export 'job_description_employer_model.dart';

class JobDescriptionEmployerWidget extends StatefulWidget {
  const JobDescriptionEmployerWidget({Key? key}) : super(key: key);

  @override
  _JobDescriptionEmployerWidgetState createState() =>
      _JobDescriptionEmployerWidgetState();
}

class _JobDescriptionEmployerWidgetState
    extends State<JobDescriptionEmployerWidget> {
  late JobDescriptionEmployerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JobDescriptionEmployerModel());
  }
