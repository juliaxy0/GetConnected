...
import 'student_feedback_done_model.dart';
export 'student_feedback_done_model.dart';

class StudentFeedbackDoneWidget extends StatefulWidget {
  const StudentFeedbackDoneWidget({Key? key}) : super(key: key);

  @override
  _StudentFeedbackDoneWidgetState createState() =>
      _StudentFeedbackDoneWidgetState();
}

class _StudentFeedbackDoneWidgetState extends State<StudentFeedbackDoneWidget> {
  late StudentFeedbackDoneModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StudentFeedbackDoneModel());
